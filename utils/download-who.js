...
const writeJsFile = async (url, filename, limitRows) => {
  ...
  await fs.writeFile(filename, `export default ${JSON.stringify(data, null, 2)};`);
  console.log(`wrote ${filename}`)
}


(async () => {
  writeJsFile('https://www.who.int/childgrowth/standards/tab_wfa_boys_p_0_5.txt', './src/boys-weight.js', 25)
  ...
  writeJsFile('https://www.who.int/childgrowth/standards/tab_lhfa_boys_p_0_2.txt', './src/boys-length.js', 25)
  ...
  writeJsFile('https://www.who.int/childgrowth/standards/tab_wfa_girls_p_0_5.txt', './src/girls-weight.js', 25)
  ...
  writeJsFile('https://www.who.int/childgrowth/standards/tab_lhfa_girls_p_0_2.txt', './src/girls-length.js', 25)
